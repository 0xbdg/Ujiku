...
urlpatterns = [
    ...
    path("test/pembelajaran/result/", ExamResultView.as_view(), name="admin-exam-result-pem"),
    path("test/pembelajaran/result/<int:pk>", ExamResultDetailView.as_view(), name="admin-exam-result-detail-pem"),
